...
//  */
// export namespace WebRTCServerConnection {
//   /**
...
//     options: Partial<WebRTCServerConnection.ISettings> = {}
//   ): WebRTCServerConnection.ISettings {
//     const pageBaseUrl = '';
//     const pageWsUrl = '';
...
//     url: string,
//     init: RequestInit,
//     settings: WebRTCServerConnection.ISettings
//   ): Promise<Response> {
...
//     const type = init.method ?? settings.init.method;
//     const data = init.body ?? settings.init.body;
...
//     return WebRTCKernelAPI.sudoHTTPRequest(url, type ?? 'GET', data);
