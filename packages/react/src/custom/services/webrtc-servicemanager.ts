...
// import { WebRTCServerConnection } from './webrtc-serverconnection';
// import { Contents, ContentsManager, Event, EventManager, Kernel, KernelManager, KernelSpec, KernelSpecManager, NbConvert, NbConvertManager, ServerConnection, Session, SessionManager, Setting, SettingManager, Terminal, TerminalManager, User, UserManager, Workspace, WorkspaceManager } from '@jupyterlab/services';
// import { Builder, BuildManager } from '@jupyterlab/services/lib/builder';
// import { KernelSpecAPIClient } from '../webrtc-restapi';

// /**
//  * A Jupyter services manager.
//  */
// export class WebRTCServiceManager implements ServiceManager.IManager {
//   /**
...
//     const normalized = { defaultDrive, serverSettings, standby, kernelAPIClient: new KernelSpecAPIClient({serverSettings}) };
